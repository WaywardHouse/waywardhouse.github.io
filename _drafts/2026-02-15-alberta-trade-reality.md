...
<!-- GDP composition chart — Mermaid pie or ECharts donut -->

```echarts
{
  "title": { "text": "Alberta GDP by Sector (2024)", "left": "center", "textStyle": { "fontSize": 16 } },
...
```echarts
{
  "title": { "text": "Alberta International Exports by Product (2024)", "left": "center", "textStyle": { "fontSize": 16 } },
  "tooltip": { "trigger": "axis", "axisPointer": { "type": "shadow" } },
  "xAxis": { "type": "value", "axisLabel": { "formatter": "${value}B" } },
  "yAxis": {
    "type": "category",
    "data": ["Other goods", "Machinery & equipment", "Petrochemicals", "Agricultural & agri-food", "Hydrocarbon gases", "Crude petroleum oils"],
    "axisLabel": { "fontSize": 12 }
  },
  "series": [{
    "type": "bar",
    "data": [22, 4.5, 1.3, 17.5, 8.3, 124.2],
...
|:---|---:|:---|
| Light petroleum products (refined fuel) | $8.2 billion | Alberta lacks sufficient refining capacity for its own crude |
...
Alberta is simultaneously the most active interprovincial seller in Canada and the most popular destination for other provinces' goods. The province is both supplier and customer to the rest of the country.
...
Alberta does not receive equalization payments — it has not in the modern program era. The last payment was in 1964–65. This is because Alberta's fiscal capacity is consistently above the national average, driven by resource wealth.[^fin-transfers]
...
|:---|---:|:---|
| Canada Health Transfer (CHT) | $6.6 billion | Per-capita; Alberta receives less per capita than average due to young population |
...
However, research by economist Trevor Tombe (University of Calgary) shows that approximately 72% of Alberta's net federal contribution is explained by Alberta's high incomes and its relatively young population — not by any structural bias in federal programs. Equalization itself accounts for only about 12% of the total fiscal gap. High earners pay more income tax; this is the primary mechanism, not equalization formula design.[^tombe]
...
This fiscal strength is both genuine and cyclically exposed: it rests heavily on resource revenues that fluctuate with global commodity prices. The 2014–2016 oil price collapse demonstrated how rapidly Alberta's fiscal position can deteriorate when prices fall.
...
At 88.5% of all international exports, Alberta's economy is more tightly coupled to the U.S. market than almost any other comparably-sized subnational jurisdiction in the world. A sustained U.S. trade disruption would be devastating in ways that no change to federal-provincial arrangements could offset. The 2025 U.S. tariff threats on Canadian energy exposed this vulnerability — and Alberta's response was to seek market diversification, not to assert greater independence from Canada.

### 6.2 Dependency on Canadian Internal Market Infrastructure

Alberta's interprovincial trade operates within a Canadian internal market that is deeply integrated: shared currency, common regulatory frameworks, tariff-free movement, and seamless financial infrastructure. Unwinding this integration would require renegotiating all of it from scratch, at significant cost regardless of the political arrangement that replaced it.

### 6.3 Dependency on Energy Prices

Alberta's fiscal surpluses, high incomes, and net contribution to federal finances are all functions of high energy prices. No change in political arrangements can eliminate this cyclical exposure. Both the boom years and the busts have been driven primarily by global commodity markets, not by Ottawa.

```echarts
{
  "title": { "text": "Alberta's Three Structural Dependencies", "left": "center", "textStyle": { "fontSize": 16 } },
  "tooltip": {},
  "radar": {
    "indicator": [
      { "name": "U.S. Market\n(88.5% of exports)", "max": 100 },
      { "name": "Canadian\nInternal Market", "max": 100 },
      { "name": "Energy\nPrice Exposure", "max": 100 },
  ...
  "series": [{
    "type": "radar",
    "data": [{
      "value": [95, 75, 90, 85, 60, 70],
      "name": "Dependency Severity",
...
|:---|:---|:---|
| U.S. market (88.5% of exports) | Full access via CUSMA | Requires renegotiation as non-Canadian partner; no guaranteed access |
| Canadian internal market | Full, tariff-free access | Loss of automatic access; new treaty required; friction costs certain |
| TMX pipeline to tidewater | Operational since May 2024 | Continuity likely but complicated by transition and ownership questions |
| Federal transfers (CHT, CST) | $8.6B annually | Would be lost; requires new fiscal arrangements or equivalent taxes |
| Shared currency (CAD) | Integrated monetary system | New currency or pegging creates exchange rate risk and transaction costs |
| Banking & financial system | Fully integrated | Disruption risk; Alberta lacks its own central bank capacity |
| Bank of Canada backstop | Lender of last resort | Loss of this function is significant during financial stress |
...
**Alberta is also genuinely integrated.** Its economy is deeply embedded in the U.S. market, the Canadian internal market, and continental supply chains. The infrastructure of that integration — pipelines, rail, shared currency, regulatory frameworks, financial systems — is not costless to replace.
...
*Next in this series: [Alberta in the Canadian Economy — A Trade Reality Check](/alberta-in-context/trade-reality-check/), which examines Alberta's interprovincial dependencies and fiscal position in fuller detail.*
